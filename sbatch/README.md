...
```bash
EJFAT_URI='ejfats://secrettoken@ejfat-lb.es.net:18008/lb/334?sync=192.188.29.6:19010&data=192.188.29.10&data=[2001:400:a300::10]' sbatch -N <num nodes> haidis/sbatch/haidis_slurm.sh 
```
